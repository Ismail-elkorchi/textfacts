import type { PackOptionsV1, TextfactsPackV1 } from "../protocol/pack-v1.ts";
import type { TextEnvelopeV1 } from "../protocol/types.ts";
import type { StandardJSONSchemaV1 } from "./standard.ts";

/**
 * TEXT_ENVELOPE_V1_SCHEMA is an exported constant used by public APIs.
 */
export const TEXT_ENVELOPE_V1_SCHEMA: Record<string, unknown> = {
  $id: "https://textfacts.dev/schema/text-envelope-v1.json",
  $schema: "https://json-schema.org/draft/2020-12/schema",
  title: "TextEnvelopeV1",
  oneOf: [
    {
      type: "object",
    ...
    },
    {
      type: "object",
      additionalProperties: false,
      required: ["v", "kind", "base64"],
      properties: {
        v: { const: 1 },
        kind: { const: "utf8-base64" },
        base64: { type: "string" },
      },
    },
    {
    ...
    },
    {
      type: "object",
      additionalProperties: false,
      required: ["v", "kind", "codeUnits"],
      properties: {
        v: { const: 1 },
        kind: { const: "utf16-code-units" },
        codeUnits: {
          type: "array",
...
/**
 * PACK_V1_SCHEMA is an exported constant used by public APIs.
 */
export const PACK_V1_SCHEMA: Record<string, unknown> = {
      ...
      properties: {
        ...
        samples: {
          ...
          properties: {
            ...
            "default-ignorable": { type: "array", items: { $ref: "#/$defs/integrityFinding" } },
...
/**
 * TextEnvelopeV1StandardJsonSchema is an exported constant used by public APIs.
 */
export const TextEnvelopeV1StandardJsonSchema: StandardJSONSchemaV1<unknown, TextEnvelopeV1> = {
  "~standard": {
    version: 1,
    vendor: "textfacts",
    jsonSchema: {
      input: () => TEXT_ENVELOPE_V1_SCHEMA,
      output: () => TEXT_ENVELOPE_V1_SCHEMA,
    },
  },
};

/**
 * PackV1StandardJsonSchema is an exported constant used by public APIs.
 */
export const PackV1StandardJsonSchema: StandardJSONSchemaV1<PackOptionsV1, TextfactsPackV1> = {
  "~standard": {
    version: 1,
    vendor: "textfacts",
    jsonSchema: {
      input: () => PACK_V1_SCHEMA,
      output: () => PACK_V1_SCHEMA,
    },
  },
};
